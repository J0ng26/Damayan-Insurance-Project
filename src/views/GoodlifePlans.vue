          ...
          <v-container class="fill-height">
            <v-row align="center" class="fill-height" data-aos="fade-up">
              <v-col cols="12" sm="12" md="7" class="text-center text-md-start">
                <h1 class="banner-titles-plan">
                  GOODLIFE PLANS INC.
                </h1>
                <p class="banner-subtitles-plan">
               With bigger benefits, we ensure that protection and financial stability 
   ...
   <v-container id="memorial-package" class="py-16" data-aos="fade-up">
    ...
    <v-row justify="center" class="mb-12">
      <v-col cols="12" class="text-center">
        ...
        />
        <p class="text-body-1 text-medium-emphasis" style="font-size: 1.125rem;">
    ...
    <v-row justify="center">
      <v-col cols="12" md="10" lg="8">
        <div class="minimal-wrapper">
          <v-row>
            ...
            <v-col cols="12" md="6" class="pr-md-8">
              <div class="section-header d-flex align-center mb-6">
                ...
                <h3 class="text-h5 font-weight-bold pl-3" style="color: #2d3748;">
                  Package Inclusions
                </h3>
              </div>
              ...
              <div class="package-list">
                ...
                >
                  ...
                  <span class="text-body-1" style="color: #2d3748; transition: color 0.2s;">
                    {{ item }}
                  </span>
                </div>
              </div>
            ...
            <v-col cols="12" md="6" class="pl-md-8 mt-12 mt-md-0">
              ...
              <div class="casket-tags mb-8">
                <div 
                  v-for="feature in ['SINGLE TOP', 'WOODEN CASKET', 'FULL GLASS', 'QUALITY & ELEGANT INTERIORS']" 
                  :key="feature"
          ...
          <!-- Minimal Footer Note -->
          <v-row justify="center" class="mt-12 pt-8" style="border-top: 1px solid #e2e8f0;">
            <v-col cols="12" md="8" class="text-center">
              <p class="text-body-2 mb-0" style="color: #718096;">
                Complete memorial service • Professional assistance • Dignified arrangements
              </p>
            </v-col>
          </v-row>
        </div>
          ...
          >
            ...
            <div class="d-flex align-center mb-4">
              <v-icon 
                ...
                class="mr-3"
              ></v-icon>
              <span class="text-subtitle-1 font-weight-medium" :class="`text-${option.color}`">
                {{ option.name }}
              </span>
              <v-spacer></v-spacer>
              <span 
  ...
  <v-row justify="center">
    <v-col cols="12" md="10" lg="8">
      ...
      <v-card variant="outlined" class="rounded-lg pa-5 mb-6">
        <div class="d-flex align-center mb-4">
          <v-icon icon="mdi-heart-pulse" size="20" color="grey-darken-2" class="mr-3"></v-icon>
      ...
      <v-card variant="outlined" class="rounded-lg pa-5 mb-6">
        <div class="d-flex align-center mb-4">
          <v-icon icon="mdi-calculator" size="20" color="grey-darken-2" class="mr-3"></v-icon>
        ...
        <div class="pl-7">
          ...
          <div class="mb-4">
            ...
            <div class="d-flex justify-space-between align-baseline">
              <span class="text-body-1 text-grey-darken-3">Total Contract Price</span>
              <span class="text-h6 font-weight-medium text-grey-darken-4">Php 48,000.00</span>
            </div>
            <div class="d-flex justify-space-between align-baseline mt-2">
              <span class="text-body-1 text-grey-darken-3 mr-2">P800.00 × 12 months</span>
              <span class="text-h6 font-weight-medium text-primary">Php 9,600.00</span>
            </div>
          </div>
          ...
          <div class="pt-3" style="border-top: 1px dashed #e2e8f0;">
            <div class="d-flex justify-space-between align-baseline">
              <span class="text-body-1 text-grey-darken-3">Waived Balance</span>
              <span class="text-h6 font-weight-medium text-grey-darken-4">38,400.00</span>
            </div>
          </div>
        </div>
      </v-card>
      ...
      <v-card variant="outlined" class="rounded-lg pa-5">
        <div class="d-flex align-center mb-4">
          <v-icon icon="mdi-shield-check" size="20" color="green" class="mr-3"></v-icon>
        ...
        <div class="pl-7">
          ...
          <div class="mb-4">
            <div class="d-flex justify-space-between align-baseline mb-1">
              <span class="text-body-1 text-grey-darken-3">Cash Assistance Benefit</span>
              <span class="text-h6 font-weight-medium text-grey-darken-4">PHP 37,525.00</span>
            </div>
          </div>
          ...
          <div class="mb-4">
            <div class="d-flex justify-space-between align-baseline mb-1">
              <span class="text-body-1 text-grey-darken-3">Memorial Service Benefit</span>
              <span class="text-h6 font-weight-medium text-grey-darken-4">PHP 37,525.00</span>
            </div>
          </div>
          ...
          <div class="pt-3 mt-4" style="border-top: 2px solid #e2e8f0;">
            <div class="d-flex justify-space-between align-baseline">
              <span class="text-subtitle-1 font-weight-medium text-grey-darken-4">Total Benefits</span>
              <span class="text-h5 font-weight-medium text-primary">PHP 75,050.00</span>
            </div>
          </div>
        </div>
      </v-card>
    ...
    <v-col cols="12" md="10" lg="8">
      ...
      <v-card variant="outlined" class="rounded-lg pa-5 mb-6">
        ...
        <div class="pl-7">
          ...
          <div class="mb-4">
            ...
            <div class="d-flex justify-space-between align-baseline mt-2">
              <span class="text-body-1 text-grey-darken-3 mr-2">P800.00 × 1 month</span>
              <span class="text-h6 font-weight-medium text-primary">Php 800.00</span>
            </div>
          </div>
          ...
          <div class="pt-3" style="border-top: 1px dashed #e2e8f0;">
            <div class="d-flex justify-space-between align-baseline">
              <span class="text-body-1 text-grey-darken-3">Waived Balance</span>
              <span class="text-h6 font-weight-medium text-grey-darken-4">47,200.00</span>
            </div>
          </div>
        </div>
      </v-card>
      ...
      <v-card variant="outlined" class="rounded-lg pa-5">
        ...
        <div class="pl-7">
          ...
          <div class="mb-4">
            <div class="d-flex justify-space-between align-baseline mb-1">
              <span class="text-body-1 text-grey-darken-3">Accidental Death Benefit</span>
              <span class="text-h6 font-weight-medium text-grey-darken-4">PHP 37,525.00</span>
            </div>
          </div>
          ...
          <div class="pt-3 mt-4" style="border-top: 2px solid #e2e8f0;">
            <div class="d-flex justify-space-between align-baseline">
              <span class="text-subtitle-1 font-weight-medium text-grey-darken-4">Total Benefits</span>
              <span class="text-h5 font-weight-medium text-primary">PHP 112,575.00</span>
            </div>
          </div>
        </div>
      </v-card>
      ...
      <div class="minimal-wrapper">
        <v-row>
          ...
          <v-col cols="12">
            <div class="section-header d-flex align-center mb-6">
              <div class="header-line"></div>
              <h3 class="text-h4 font-weight-bold pl-3" style="color: #2d3748;">
                SPECIAL FEATURES
              </h3>
            </div>
            ...
            <div class="package-list">
              ...
              >
                ...
                <div>
                  <span class="text-h6 font-weight-medium" style="color: #2d3748; transition: color 0.2s; font-weight: 500;">
                    Assignability
                  </span>
              ...
              >
                ...
                <div>
                  ...
                  <p class="text-body-1 mb-0" style="color: #718096;">
                    The memorial service benefits increases 5% of the contract price that starts on the 6th policy year up to 150% of the contract price.
                  </p>
                </div>
              </div>
            </div>
        ...
        <!-- Minimal Footer Note -->
        <v-row justify="center" class="mt-12 pt-8" style="border-top: 1px solid #e2e8f0;" data-aos="fade-up">
          <v-col cols="12" md="8" class="text-center">
